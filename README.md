...
4. Built with Tkinter for GUI and OpenCV for video processing.
**Phase 2**
...
4. Enhanced feedback with audio cues and status overlays.
**Phase 3**
**Movement Classification & RL Agent**
...
5. Trains a DQN agent to learn optimal behavior during light transitions.
**Phase 4**
**Full Integration & GUI Game**
...
2.Runs entirely in real time and supports multiple players simultaneously.
